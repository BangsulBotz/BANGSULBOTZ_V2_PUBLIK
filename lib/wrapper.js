...
export async function smsg(sock) {
    ...
    // --- [4. send with thumbnail] - FIXED MENTION HANDLER ---
    ...
    */
    ...
    sock.sendWithThumbnail = async (jid, data = {}, quoted = null, options = {}) => {
        ...
        // ====================== AUTO MENTION HANDLER - ANTI DOUBLE ======================
        const mentionedJid = new Set();

        // 1. Ambil semua mention manual dari restData.mentions (prioritas tinggi)
        ...
        // 2. Tangkap Full JID yang sudah ditulis di teks ( @628xx@s.whatsapp.net atau @628xx@lid )
        ...
        // 3. Tangkap hanya @nomor (contoh: @6282268881337) → hanya jika nomor tersebut BELUM ada di mentionedJid
        ...
        // Bersihkan teks: ganti semua full JID dan @nomor menjadi tampilan cantik @nomor
        finalText = finalText
